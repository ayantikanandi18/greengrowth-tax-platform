...
export const SARAH_DOCUMENTS: TaxDocument[] = [
  ...
  },
  {
    id: "d-sarah-1099int",
    returnId: "r-sarah-2025",
    name: "1099-INT — Cedarline Savings Bank",
    docType: "1099-INT",
    category: "Income",
    uploadedAt: daysAgo(35),
    uploadedBy: "client",
    pageCount: 1,
    vendor: "Cedarline Savings Bank",
    amount: 612,
    tags: ["interest"],
  },
  {
...
export const SARAH_FIELDS: ExtractedField[] = [
  {
    ...
    value: "$114,600",
    sources: [
      { documentId: "d-sarah-w2-1", page: 1, regionLabel: "Box 1 — $96,400" },
      { documentId: "d-sarah-w2-2", page: 1, regionLabel: "Box 1 — $18,200" },
    ],
  ...
  },
  {
    ...
    value: "$612",
    sources: [{ documentId: "d-sarah-1099int", page: 1, regionLabel: "Box 1" }],
  ...
  },
  {
    ...
    value: "$2,140",
    sources: [{ documentId: "d-sarah-1099div", page: 1, regionLabel: "Box 1a" }],
    transformation: "Direct copy, no transformation",
  ...
  },
  {
    ...
    value: "$11,250",
    sources: [{ documentId: "d-sarah-1098", page: 1, regionLabel: "Box 1" }],
    transformation: "Direct copy, no transformation",
    dataState: "verified",
    confidence: 0.97,
  },
  {
    ...
    value: "$2,385",
    sources: Array.from({ length: 6 }).map((_, i) => ({
      documentId: `d-sarah-charity-${i + 1}`,
      page: 1,
      regionLabel: "Donation amount",
    })),
